...
const Home = () => (
  <section id="home" className="pb-20 mt-20 bg-gradient-to-br from-green-50 via-white to-lime-50 min-h-screen flex items-center justify-center animate-fadeIn">
